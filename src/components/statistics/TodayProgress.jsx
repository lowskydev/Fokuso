        ...
        <div className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-muted/30 rounded-xl">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-sm font-medium text-foreground">Sessions Throughout the Day</h4>
            ...
            <ChartContainer config={chartConfig}>
              ...
              >
                ...
                <Line dataKey="sessions" type="linear" stroke="#ef4444" strokeWidth={3} dot={false} />
              </LineChart>
            </ChartContainer>
          </div>
        </div>
