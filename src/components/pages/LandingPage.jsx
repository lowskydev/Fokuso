...
function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Track your progress and optimize your study habits with detailed insights",
      icon: BarChart3,
        ...
        <section className="px-6 py-20 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Transform your productivity with Fokuso's intelligent study
              system.
              <span className="font-semibold text-primary">
                {" "}
                Start your focus journey today
              </span>{" "}
              and discover what you can achieve.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Everything you need to transform your study habits and achieve
                your goals
              </p>
            </div>
              ...
              <Card className="p-6 bg-card/80 backdrop-blur-sm border-border shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                <CardContent className="p-0">
                  ...
                  <p className="text-muted-foreground">
                    Built on proven Pomodoro Technique research
                  </p>
                </CardContent>
              </Card>
              <Card className="p-6 bg-card/80 backdrop-blur-sm border-border shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        ...
        <section className="px-6 py-20 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Start your productivity journey today with our science-based
              approach to focused learning.
            </p>
            <Link to="/register">
              <Button
                size="lg"
